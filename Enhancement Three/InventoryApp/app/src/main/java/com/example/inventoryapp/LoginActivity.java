...
public class LoginActivity extends AppCompatActivity {
    ...
    // Navigate to the databases home page after logging in.
    private void navigateToDatabasePage(int userId) {
        Intent intent = new Intent(LoginActivity.this, DatabaseListActivity.class);
