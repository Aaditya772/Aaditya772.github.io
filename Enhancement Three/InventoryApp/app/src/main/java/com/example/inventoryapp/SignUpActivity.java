...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void handleSignUp() {
        ...
        // Transition user into database home page.
        Intent intent = new Intent(SignUpActivity.this, DatabaseListActivity.class);
        intent.putExtra(LoginActivity.EXTRA_USER_ID, newUserId);
        startActivity(intent);

        // Finish this screen context so clicking 'Back' from
        // database doesn't return to the Signup view.
        finish();
    }
