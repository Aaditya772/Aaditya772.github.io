...
public class InventoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Toolbar to replace the action bar and hold the search feature.
        ...
        // added no
        int currentUserId = getIntent().getIntExtra(
                LoginActivity.EXTRA_USER_ID,
                INVALID_USER_ID);

        //added
        currentDatabaseId = getIntent().getIntExtra(
    ...
    // Search logic using SearchView and onQueryTextChange/Listener.
    @Override
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if (newText == null || newText.trim().isEmpty()) {
                    cursor = db.getItemsByDatabase(
                            // edited
                            currentDatabaseId); // currentUserId

                } else {
                    // cursor = db.searchItemsByUser(currentUserId, newText.trim());
                    // added
                    cursor = db.searchItemsByDatabase(
                            currentDatabaseId,
                            newText.trim());
                }
    ...
    public void loadData() {
        //edited
        Cursor cursor = db.getItemsByDatabase(
                currentDatabaseId);
    ...
    private void showAddDialog() {
        ...
        saveBtn.setOnClickListener(v -> {
            ...
            try {
                ...
                //edited
                db.addItem(name, quantity, currentDatabaseId);
                loadData();
